"""
Django settings for pinode project.
...
SECRET_KEY = 'wml6+8t_-$x(2b)uu((+u%0nw-xl(_j4vrgsp)cs2$34z=j!4%'
...
WSGI_APPLICATION = 'pinode.wsgi.application'
